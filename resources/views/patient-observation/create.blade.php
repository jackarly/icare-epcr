                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('observation.store', $patient->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="observations" class="form-control @error('observations') is-invalid @enderror" name="observations" value="{{ old('observations') }}" required autocomplete="observations" autofocus></textarea>
